...
<div class="flex flex-col w-full h-full">
  <div class="w-full">
    <form action="?/updatePassword" method="POST" class="flex flex-col space-y-2 w-fit mx-auto">
      ...
      <a href="/auth/reset-password" class="text-primary hover:cursor-point hover:underline">
